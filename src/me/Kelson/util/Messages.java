...
public class Messages {
	...
	private static String NoPermissionError = Commands.main + ChatColor.DARK_RED + "Error: "
			+ ChatColor.RED + "You do not have permission to use that command!";

	private static String NoPermissionErrorOth = Commands.main + ChatColor.DARK_RED + "Error: "
